...
<body style="background-image:url(img/foodbackgroundimage.jpg);">
    ...
    ?>
		...
		<a href="admindashboard.php"><button class="btn btn-danger" style="margin-top:10px;">Back</button></a>
		<form action="chefsignup.php" method="post" enctype="multipart/form-data">
			<div class="fields">
				...
				<div class="input-field">
					...
					<input type="date" name="dob" placeholder="Email" required/>
				</div>
				<div class="input-field">
					<label>Qualification</label>
					<textarea name="qulification" id="" placeholder="Qualification" required></textarea>
				</div>
				<div class="input-field">
				...
				<div class="input-field">
					...
					<input type="text" name="chef"  placeholder="Chef" required/>
				</div>
				<div class="input-field">
