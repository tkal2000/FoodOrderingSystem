				...
				<a href="viewsupplier.php"><button class="btn btn-danger" style="margin-top:20px;">Back</button></a> 
					<form action="updatesupplier.php" method="post" enctype="multipart/form-data">
						<div class="fields">
                            ...
                            <div class="input-field">
								<label>Email</label>
								<input type="email" name="se"  value="<?php echo $row["s_email"]; ?>" class="form-control" disabled>
							</div>
						</div>	
                            <input type="submit" name="supplierupdate" value="Update" class="btn btn-primary">
						</form>
	</div>
	<?php
                }
