					...
					<form action="#" method="post" enctype="multipart/form-data">
						<div class="fields">
							...
							<div class="input-field">
								...
								<img src="data:img/jpg;charset=utf;base64,<?php echo base64_encode ($row["d_profile_photo"]);?>" style="width:100px;height:100px;" class="form-control">
							</div>
							<div class="input-field">
								<label>Address</label>
                            ...
                            <div class="input-field">
								<label>Email</label>
								<input type="email" name="de"  value="<?php echo $row["d_email"]; ?>" class="form-control">
							</div>
                            <div class="input-field">
